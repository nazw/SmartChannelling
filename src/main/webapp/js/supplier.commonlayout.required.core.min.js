...
$(function(){var a=$("#loginButton");var b=$("#loginBox");var c=$("#loginForm");a.removeAttr("href");a.mouseup(function(c){var d=$("#alertCount").val();if(d>0){b.toggle();a.toggleClass("active")}else if(d==0){b.toggle()}else{b.toggle()}});c.mouseup(function(){return false});$(this).mouseup(function(c){if(!($(c.target).parent("#loginButton").length>0)){var d=$("#alertCount").val();if(d>0){a.removeClass("active")}b.hide()}})})
 /*login.js*/
 function close_box(a,b){document.getElementById(a).style.display="none";document.getElementById(b).style.display="none"}function demen(a,b,c,d){if(self.innerHeight){scnWid=self.innerWidth;scnHei=self.innerHeight}else if(document.documentElement&&document.documentElement.clientHeight){scnWid=document.documentElement.clientWidth;scnHei=document.documentElement.clientHeight}else if(document.body){scnWid=document.body.clientWidth;scnHei=document.body.clientHeight}document.getElementById(a).style.left=(scnWid-c)/2+"px";document.getElementById(a).style.top=(scnHei-d)/2+"px";document.getElementById(a).style.display="block";document.getElementById(b).style.width=scnWid+"px";document.getElementById(b).style.height=scnHei+"px";document.getElementById(b).style.display="block"}var scnWid=0;var scnHei=0
