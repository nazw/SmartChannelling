...
<div style="display: block;"><h1>Add Specialization</h1>
    ...
    <form:form id="form2" name="form2" method="post" action="updateSpecialization.htm" modelAttribute="specialization" onsubmit="return specializationform()" >
        ...
        <div class="row">
            ...
            <div class="col2">
            	<textarea name="description"  class="textArea" id="description" cols="30" rows="6">${specialization.description}</textarea>        
            </div>
            <div class="clear"></div>
        </div>
