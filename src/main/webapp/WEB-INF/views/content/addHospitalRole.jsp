...
<div style="display: block;"><h1>Add Hospital Roles</h1>
    ...
    <form:form id="form2" name="form2" method="post" action="addHospitalRole.htm" modelAttribute="hospitalRole" onsubmit="return hospitalRoleform()" >

        <div class="row">
            <div class="col1">Designation Name</div>
            <div class="col2">
                <form:input path="name" cssClass="textField" id="name" />   <span class="mandotary">*</span>
            </div>
            <div class="clear"></div>
        </div>                                                  
